-- ============================================================
-- Atlas Commercial System — 022
-- Paddle account billing state
--
-- Extends the service-only customer portal context with the safe
-- subscription state Atlas needs to render native billing UI.
-- Provider customer/subscription IDs remain server-only.
-- ============================================================
