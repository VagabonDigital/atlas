-- ============================================================
-- Atlas Commercial System — 029
-- Billing communication ownership cleanup
--
-- Paddle owns routine payment confirmation and cancellation-reversal
-- communication. Atlas keeps product-state and account-security messages.
-- This updates the live billing email classifier accordingly.
-- ============================================================
