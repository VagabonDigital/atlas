...
function renderAtlasAuthEmailPreview(kind) {
    const accountUrl =
        'https://atlasfortutors.com/account/';

    const previewNewEmail =
        'new-email@example.com';

    const previewOldEmail =
        'old-email@example.com';

    const previewCurrentEmail =
        'current-email@example.com';

    if (kind === 'confirm_signup') {
        return {
            subject:
                'Confirm your email',
            html:
                '<div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">Confirm your email address to finish creating your Atlas account.</div>' +
                '<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;margin:0;padding:0;background:#f3f0e9;"><tr><td align="center" style="padding:40px 18px;">' +
                '<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:560px;background:#fffdf9;border:1px solid #e2ddd4;border-radius:22px;overflow:hidden;">' +
                '<tr><td style="padding:38px 42px 10px 42px;"><div style="font-family:Georgia,\'Times New Roman\',serif;font-size:36px;line-height:1;color:#24211d;letter-spacing:-0.5px;">Atlas</div>' +
                '<div style="margin-top:9px;font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:700;letter-spacing:2px;color:#7d766d;">FOR TUTORS</div>' +
                '<div style="width:54px;height:6px;margin-top:22px;background:#4d7184;border-radius:999px;"></div></td></tr>' +
                '<tr><td style="padding:24px 42px 42px 42px;"><h1 style="margin:0 0 16px 0;font-family:Georgia,\'Times New Roman\',serif;font-size:30px;line-height:1.2;font-weight:400;color:#24211d;">Confirm your email</h1>' +
                '<p style="margin:0 0 28px 0;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:1.65;color:#625c53;">Confirm your email address to finish creating your Atlas account.</p>' +
                '<a href="' + accountUrl + '" style="display:inline-block;padding:15px 24px;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:1;font-weight:700;color:#ffffff;text-decoration:none;border-radius:12px;background:#4d7184;">Confirm email address</a>' +
                '<p style="margin:30px 0 0 0;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:1.6;color:#8a8379;">If you didn’t create an Atlas account, you can safely ignore this email.</p></td></tr>' +
                '<tr><td style="padding:20px 42px;border-top:1px solid #ece7df;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:1.5;color:#9a9389;">Atlas · atlasfortutors.com</td></tr></table></td></tr></table>'
        };
    }

    if (kind === 'change_email_address') {
        return {
            subject:
                'Confirm your new email',
            html:
                '<div style="margin:0;padding:40px 16px;background:#f3f0e9;font-family:Arial,Helvetica,sans-serif;color:#2b2926;"><div style="max-width:620px;margin:0 auto;background:#fffdf9;border:1px solid #ded7cc;border-radius:18px;overflow:hidden;">' +
                '<div style="padding:42px 48px 34px;"><div style="font-family:Georgia,\'Times New Roman\',serif;font-size:38px;line-height:1;color:#24211d;">Atlas</div><div style="margin-top:10px;font-size:12px;font-weight:700;letter-spacing:3px;color:#7b7469;">FOR TUTORS</div>' +
                '<div style="width:64px;height:6px;margin:28px 0 36px;background:#4d7184;border-radius:99px;"></div><div style="font-family:Georgia,\'Times New Roman\',serif;font-size:30px;line-height:1.2;color:#24211d;">Confirm your new email</div>' +
                '<p style="margin:22px 0 0;font-size:16px;line-height:1.65;color:#625c53;">Confirm <strong>' + previewNewEmail + '</strong> as the new sign-in email for your Atlas account.</p>' +
                '<div style="margin-top:30px;"><a href="' + accountUrl + '" style="display:inline-block;padding:15px 24px;background:#4d7184;color:#ffffff;text-decoration:none;font-size:16px;font-weight:700;border-radius:10px;">Confirm new email</a></div>' +
                '<p style="margin:30px 0 0;font-size:13px;line-height:1.6;color:#8a8379;">If you didn’t request this change, you can safely ignore this email.</p></div>' +
                '<div style="padding:22px 48px;border-top:1px solid #e7e1d8;font-size:12px;color:#999186;">Atlas · atlasfortutors.com</div></div></div>'
        };
    }
    ...
    if (kind === 'reset_password') {
        return {
            ...
            html:
                '<div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">Reset the password for your Atlas account.</div>' +
                '<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;margin:0;padding:0;background:#f3f0e9;"><tr><td align="center" style="padding:40px 18px;">' +
                '<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:560px;background:#fffdf9;border:1px solid #e2ddd4;border-radius:22px;overflow:hidden;">' +
                '<tr><td style="padding:38px 42px 10px 42px;"><div style="font-family:Georgia,\'Times New Roman\',serif;font-size:36px;line-height:1;color:#24211d;letter-spacing:-0.5px;">Atlas</div>' +
                '<div style="margin-top:9px;font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:700;letter-spacing:2px;color:#7d766d;">FOR TUTORS</div><div style="width:54px;height:6px;margin-top:22px;background:#4d7184;border-radius:999px;"></div></td></tr>' +
                '<tr><td style="padding:24px 42px 42px 42px;"><h1 style="margin:0 0 16px 0;font-family:Georgia,\'Times New Roman\',serif;font-size:30px;line-height:1.2;font-weight:400;color:#24211d;">Reset your password</h1>' +
                '<p style="margin:0 0 28px 0;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:1.65;color:#625c53;">Use the link below to choose a new password for your Atlas account.</p>' +
                '<a href="' + accountUrl + '" style="display:inline-block;padding:15px 24px;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:1;font-weight:700;color:#ffffff;text-decoration:none;border-radius:12px;background:#4d7184;">Reset password</a>' +
                '<p style="margin:30px 0 0 0;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:1.6;color:#8a8379;">If you didn’t request a password reset, you can safely ignore this email.</p></td></tr>' +
                '<tr><td style="padding:20px 42px;border-top:1px solid #ece7df;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:1.5;color:#9a9389;">Atlas · atlasfortutors.com</td></tr></table></td></tr></table>'
        };
    }
    ...
    if (kind === 'password_changed') {
        return {
            subject:
                'Your Atlas password was changed',
            html:
                '<div style="margin:0;padding:48px 20px;background:#f3f0e9;font-family:Arial,sans-serif;color:#2b2926;"><div style="max-width:620px;margin:0 auto;background:#fffdf9;border:1px solid #e2ddd4;border-radius:22px;overflow:hidden;">' +
                '<div style="padding:46px 50px 24px;"><div style="font-family:Georgia,serif;font-size:42px;line-height:1;color:#2b2926;">Atlas</div><div style="margin-top:10px;font-size:13px;letter-spacing:3px;color:#7b7469;">FOR TUTORS</div><div style="width:64px;height:6px;margin-top:28px;background:#4d7184;border-radius:999px;"></div></div>' +
                '<div style="padding:18px 50px 48px;"><h1 style="margin:0 0 22px;font-family:Georgia,serif;font-size:34px;font-weight:400;line-height:1.15;color:#2b2926;">Your password was changed</h1>' +
                '<p style="margin:0 0 18px;font-size:17px;line-height:1.6;color:#625c53;">The password for your Atlas account was recently changed.</p>' +
                '<p style="margin:0 0 28px;font-size:17px;line-height:1.6;color:#625c53;">If you made this change, there’s nothing else you need to do.</p>' +
                '<p style="margin:0;font-size:15px;line-height:1.6;color:#7b7469;">If you didn’t make this change, reset your password as soon as possible and contact Atlas.</p></div>' +
                '<div style="padding:22px 50px;border-top:1px solid #e8e3da;font-size:13px;color:#918a80;">Atlas · atlasfortutors.com</div></div></div>'
        };
    }

    if (kind === 'email_address_changed') {
        return {
            subject:
                'Your Atlas email address was changed',
            html:
                '<div style="margin:0;padding:48px 20px;background:#f3f0e9;font-family:Arial,sans-serif;color:#2b2926;"><div style="max-width:620px;margin:0 auto;background:#fffdf9;border:1px solid #e2ddd4;border-radius:22px;overflow:hidden;">' +
                '<div style="padding:46px 50px 24px;"><div style="font-family:Georgia,serif;font-size:42px;line-height:1;color:#2b2926;">Atlas</div><div style="margin-top:10px;font-size:13px;letter-spacing:3px;color:#7b7469;">FOR TUTORS</div><div style="width:64px;height:6px;margin-top:28px;background:#4d7184;border-radius:999px;"></div></div>' +
                '<div style="padding:18px 50px 48px;"><h1 style="margin:0 0 22px;font-family:Georgia,serif;font-size:34px;font-weight:400;line-height:1.15;color:#2b2926;">Your email address was changed</h1>' +
                '<p style="margin:0 0 18px;font-size:17px;line-height:1.6;color:#625c53;">The email address for your Atlas account was changed from <strong>' + previewOldEmail + '</strong> to <strong>' + previewCurrentEmail + '</strong>.</p>' +
                '<p style="margin:0 0 28px;font-size:17px;line-height:1.6;color:#625c53;">If you made this change, there’s nothing else you need to do.</p>' +
                '<p style="margin:0;font-size:15px;line-height:1.6;color:#7b7469;">If you didn’t make this change, secure your Atlas account immediately.</p></div>' +
                '<div style="padding:22px 50px;border-top:1px solid #e8e3da;font-size:13px;color:#918a80;">Atlas · atlasfortutors.com</div></div></div>'
        };
    }

    throw new Error(
        'Atlas auth email preview kind is not supported.'
    );
}

async function sendAtlasAuthEmailGallery(
    env,
    recipientEmail,
    userId
) {
    ...
    if (!apiKey || !to || !owner) {
        throw new Error(
            'Atlas auth email gallery is not configured.'
        );
    }
            ...
            'https://api.resend.com/emails/batch',
            {
                ...
                headers: {
                    ...
                    'Content-Type':
                        'application/json',
                    'Idempotency-Key':
                        `atlas-auth-email-gallery:${owner}:v1`
                },
                body:
                    JSON.stringify(
                        messages
    ...
    if (delivered !== emailKinds.length) {
        throw new Error(
            'Resend did not confirm every Atlas auth preview email.'
        );
    }
...
export default {
    async fetch(request, env) {
        ...
        if (
                ...
                return json(
                    {
                        ok: false,
                        error:
                            'Atlas auth email gallery is unavailable.'
                    },
                    404
                );
            }
            ...
            try {
                const delivery =
                    await sendAtlasAuthEmailGallery(
                        env,
                        auth.email,
                        auth.userId
                    );
                ...
                console.error(
                    '[Atlas Auth Email Gallery] Send failed:',
                    error
                );
                ...
                return json(
                    {
                        ok: false,
                        error:
                            'Atlas auth email gallery could not be sent.'
                    },
                    500
                );
            }
                        ...
                        'https://api.openai.com/v1/responses',
                        {
                            ...
                            body: JSON.stringify({
                                ...
                                instructions: [
                                    ...
                                    'If context.topicFocus is non-empty, it is a mandatory hard constraint inside the selected discovery mode.',
                                    'Every one of the three suggestions must have the supplied focus as a central part of the subject, not merely a loose association, neighbouring theme, or possible conversational connection.',
                                    'Interpret the focus naturally and semantically rather than requiring an exact keyword match.',
                                    'Create variety within the supplied focus. Never leave the focus merely to make the three ideas more varied.',
                                    'For example, if the mode is Science & Nature and the focus is animals, all three ideas must centrally concern animals, species, animal behaviour, animal biology, animal cognition, ecology involving animals, or another clearly animal-centred subject. A general Science & Nature idea such as ball lightning would be invalid.',
                                    'Before returning the final three ideas, check each suggestion individually against context.topicFocus. If any idea is not clearly and centrally about that focus, replace it.',
