                        ...
                        'https://api.openai.com/v1/responses',
                        {
                            ...
                            body: JSON.stringify({
                                ...
                                instructions: [
                                    ...
                                    'Each Moment needs a compact preview and one strong learner-facing question.',
                                    ...
                                    'The preview is not merely a label. When useful, let it contribute one concise fact, example, contrast, situation, distinction, or observation that gives the learner something concrete to think with before the question.',
                                    'For grammar, vocabulary, pronunciation, communication, or other language-focused subjects, a preview may show a short real-language example or meaningful contrast in form, meaning, tone, register, politeness, implication, or use.',
                                    'Do not turn the preview into explanatory prose or a mini-paragraph. If useful setup would require more than one short sentence, simplify it to the strongest idea and let the question carry the conversation forward.',
                                    'If a Moment does not need new information, use the preview for a vivid situation, observation, or framing instead.',
                    ...
                    'https://api.openai.com/v1/responses',
                    {
                        ...
                        body: JSON.stringify({
                            ...
                            instructions: [
                                ...
                                'The preview is not merely a browse label. When useful, let it contribute one concise fact, example, contrast, situation, distinction, or observation that gives the learner something concrete to think with.',
                                'For grammar, vocabulary, pronunciation, communication, or other language-focused subjects, a preview may show a short real-language example or meaningful contrast in form, meaning, tone, register, politeness, implication, or use.',
                                'Do not turn the preview into explanatory prose or a mini-paragraph. If useful setup would require more than one short sentence, simplify it to the strongest idea and let the question carry the conversation forward.',
                                'When no explanation is needed, use a vivid situation, observation, or framing instead.',
