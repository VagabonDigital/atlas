                        ...
                        'https://api.openai.com/v1/responses',
                        {
                            ...
                            body: JSON.stringify({
                                ...
                                instructions: [
                                    ...
                                    '',
                                    'Your job is NOT to generate an image. Your job is to deeply understand the supplied subject and decide what kinds of EXISTING real photographs should be searched for to represent it beautifully.',
                                    '',
                                    'Think carefully before committing to photographic directions.',
                                    'Read the title, Library introduction, and hook together as one editorial brief.',
                                    'Work out what the conversation is actually about beneath the surface wording: its central proposition, tension, curiosity, human experience, emotional register, and particular angle.',
                                    '',
                                    'Explicitly guard against the easiest literal interpretation.',
                                    'A named person, place, era, object, story, profession, or concept in the title is not automatically what the photograph should depict.',
                                    'For example, a subject about whether an old story still deserves its reputation is not automatically a subject about ancient ruins.',
                                    'Literal imagery is welcome when it genuinely communicates the editorial idea; reject it when it merely illustrates a keyword.',
                                    '',
                                    'Before choosing search directions, consider several substantially different ways a strong human editor might communicate the subject photographically.',
                                    'Prefer visual metaphor, human situations, atmosphere, behaviour, place, scale, contrast, action, objects, or documentary moments when they express the subject more intelligently than obvious title-matching.',
                                    '',
                                    'Create one concise but information-rich visual brief that captures the subject’s real editorial meaning, intended emotional register, and the photographic qualities the final cover should have.',
                                    '',
                                    'Then create exactly four supplementary photographic search queries.',
                                    'The exact subject title will be searched separately and automatically as the primary anchor query.',
                                    'Do not repeat or lightly rewrite the exact title as one of these supplementary queries.',
                                    'Use the four supplementary queries to broaden the candidate pool with genuinely different photographic interpretations.',
                                    ...
                                    '',
                                    'Match the emotional register of the subject before chasing literal keyword relevance.',
                                    'If the subject is playful, funny, warm, whimsical, curious, celebratory, or light, keep the photographic direction playful, warm, curious, or light too.',
                                    'Do not turn words such as monster, fear, strange, dark, death, danger, or mystery into horror imagery unless the supplied subject framing clearly makes fear, horror, or threat the intended experience.',
                                    'Adult does not mean dark, austere, grim, or disturbing. A playful adult subject may still use colourful, quirky, joyful, theatrical, or gently surreal photography.',
                                    '',
                                    'Prefer sophisticated editorial or documentary feeling, strong composition, human curiosity, specificity, atmosphere, visual surprise, and immediate conversational intrigue.',
                                    'Avoid generic corporate stock imagery, staged handshakes, obvious classroom imagery, clip-art concepts, text, logos, signs as the main subject, and empty visual clichés.',
                                    '',
                                    'The standard is not simply whether an image would be relevant.',
                                    'The standard is whether a strong human editor who fully understood the subject would consider that photographic direction an intelligent and compelling cover.',
                                    '',
                        ...
                        'https://api.openai.com/v1/responses',
                        {
                            ...
                            body: JSON.stringify({
                                ...
                                instructions: [
                                    ...
                                    '',
                                    'Return up to three strong candidate photo IDs in descending order.',
                                    'It is acceptable to return fewer than three, including zero, rather than approve a cover that is tonally wrong or not good enough to ship.',
                                    '',
                                    'Judge the actual photographs, not just their search terms or alt text.',
                                    'Treat the supplied visual brief as the editorial interpretation of what the subject is really about, not as optional flavour.',
                                    'The first choice should be good enough that a tutor would usually leave it untouched.',
                                    '',
                                    'Apply this decision hierarchy in order:',
                                    '',
                                    '1. SUBJECT FIDELITY',
                                    'The photograph must genuinely belong to or meaningfully represent the supplied subject.',
                                    'If the title refers to a specific known work, franchise, person, brand, place, event, object, or cultural property, preserve that identity.',
                                    'Do not substitute imagery that merely resembles, metaphorically echoes, or shares words with that referent.',
                                    'A beautiful or clever photograph cannot compensate for losing the subject.',
                                    '',
                                    '2. EDITORIAL CONTRIBUTION',
                                    'Among photographs that pass subject fidelity, prefer imagery that adds atmosphere, personality, tension, curiosity, humour, humanity, or another useful visual layer rather than merely duplicating the title.',
                                    '',
                                    '3. VISUAL QUALITY',
                                    'Only after fidelity and editorial contribution are satisfied should composition, crop suitability, photographic quality, and visual impact decide between candidates.',
                                    '',
                                    'If no supplied photograph passes the subject-fidelity threshold, return an empty rankedPhotoIds array.',
                                    'Do not choose a weakly related photograph merely because something must win.',
                                    '',
                                    'Emotional register is a hard constraint:',
                                    '- infer the intended tone from the title, Library introduction, hook, and visual brief',
                                    '- semantic relevance does not compensate for a major tonal mismatch',
                                    '- playful, humorous, warm, whimsical, curious, or light subjects must not be represented by ominous, disturbing, threatening, bleak, uncanny, or horror-coded imagery unless that tone is explicitly central to the subject',
                                    '- adult suitability does not mean seriousness or darkness',
                                    '',
                                    'Prioritize:',
                                    '- a compelling visual connection to what the subject actually means',
                                    '- an emotional tone that matches the intended learner experience',
                                    ...
                                    '',
                                    'Reject:',
                                    '- any photograph whose emotional tone materially conflicts with the subject',
                                    '- unexpectedly frightening, disturbing, grotesque, threatening, or horror-coded imagery unless the subject explicitly calls for that experience',
                        ...
                        'https://api.openai.com/v1/responses',
                        {
                            ...
                            body: JSON.stringify({
                                ...
                                instructions: [
                                    ...
                                    '- Explicit current interests and durable preferences are positive recommendation territory. They may be used directly when they can support a fresh, specific conversational premise.',
                                    '- Topics, events, examples, and themes explicitly described as previous conversations are coverage history. Their presence is normally a reason to move elsewhere, not a reason to recommend them again.',
                                    '- Do not assume that an interest has already been covered merely because it appears in notes.',
                                    ...
                                    '',
                                    'Distinguish interest from repetition.',
                                    'If the learner likes manga, fantasy fiction, music, football, technology, cooking, or another explicit subject area, that area is legitimate source territory until the context shows it has already been sufficiently covered.',
                                    'Turn explicit interests into strong conversational premises rather than returning broad category labels.',
                                    '',
                                    'When meaningful explicit learner interests exist, normally make at least one of the final three ideas directly rooted in an underused explicit interest.',
                                    'RecentSuggestions and sessionSubjects should help rotate which learner interests are explored rather than repeatedly mining the same one.',
                                    'The other two ideas should retain broad editorial freedom so personalization does not become a cage.',
                                    '',
                                    'Use inferred personality, conversational style, humour, curiosity, and ways of thinking to improve all three ideas, but do not abstract away from concrete interests when those interests themselves offer strong unexplored territory.',
                                    '',
                                    ...
                                    'A narrower subject inside a broad existing territory is acceptable only when it creates a genuinely distinct conversation.',
                                    '',
                                    'Treat recentSuggestions as short-term coverage history, not learner evidence.',
                                    'Do not repeat, rename, lightly remix, or stay materially adjacent to recentSuggestions.',
                                    'When recentSuggestions are present, interpret the request as: take me somewhere else.',
                                    '',
                                    'When meaningful learner context exists, the full set should feel informed by what Compass knows about the learner while still preserving breadth, novelty, and surprise.',
                                    '',
                                    'When learner context is sparse or absent, behave as a broad editor rather than a personalization engine.',
                                    'Explore the full breadth of adult conversational territory before choosing the final ideas: history, science, nature, technology and design, arts and media, language, places, society, work and economics, relationships, objects and systems, everyday life, speculative situations, and other strong territory are all available.',
                                    'Everyday behaviour and cultural micro-patterns are one valid territory among many, not the default form of an interesting subject.',
                                    '',
                                    'Each idea must be specific enough to become an Atlas subject immediately.',
                                    'Broad domains are welcome as source territory, but the final title must name a specific, intriguing conversation rather than a generic category.',
                                    '',
                                    'Choose the three final ideas from substantially different conversational worlds.',
                                    'Do not return three variations of the same editorial pattern even when the titles are technically different.',
                                    '',
                        ...
                        'https://api.openai.com/v1/responses',
                        {
                            ...
                            body: JSON.stringify({
                                ...
                                instructions: [
                                    ...
                                    'Preserve the full specificity of the named subject, including modifiers that distinguish it from a broader parent category.',
                                    'Broaden the perspective, not the subject: do not turn a specific subtype, activity, phenomenon, or context into its more general category merely to create more Cultural Lens territory.',
                                    '',
                        ...
                        'https://api.openai.com/v1/responses',
                        {
                            ...
                            body: JSON.stringify({
                                ...
                                instructions: [
                                    ...
                                    'Each card must remain specifically about the named subject, not merely its broader parent category.',
