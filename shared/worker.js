                        ...
                        'https://api.openai.com/v1/responses',
                        {
                            ...
                            body: JSON.stringify({
                                ...
                                instructions: [
                                    ...
                                    'The preview is not merely a label. Let it do useful setup work when that improves the conversation: introduce one concise fact, example, contrast, situation, distinction, or observation that gives the learner something concrete to think with before the question.',
                                    'For grammar, vocabulary, pronunciation, communication, or other language-focused subjects, use previews where useful to show real language in context: an example sentence, a meaningful contrast between forms, or a practical difference in meaning, tone, register, politeness, implication, or use.',
                                    'Keep this lightweight and conversational rather than turning Moments into textbook explanations. If a Moment does not need new information, use the preview for a vivid situation, observation, or framing instead.',
                                    'The question should clearly build from the preview rather than merely repeating it.',
                    ...
                    'https://api.openai.com/v1/responses',
                    {
                        ...
                        body: JSON.stringify({
                            ...
                            instructions: [
                                ...
                                '',
                                'preview should be short, but it is not merely a browse label. Let it provide useful setup when that improves the Moment: one concise fact, example, contrast, situation, distinction, or observation that gives the learner something concrete to think with.',
                                'For grammar, vocabulary, pronunciation, communication, or other language-focused subjects, previews may show real language in context: an example sentence, a meaningful contrast between forms, or a practical difference in meaning, tone, register, politeness, implication, or use.',
                                'Do not force every preview into a mini-lesson. When no explanation is needed, use a vivid situation, observation, or framing instead.',
                                'Do not invent precise factual claims when the supplied context does not support them.',
                                'question should be one strong learner-facing spoken discussion question that clearly builds from the preview.',
                                '',
                                'Return only the requested structured payload.'
                            ].join('\n'),
