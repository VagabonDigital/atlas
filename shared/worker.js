                        ...
                        'https://api.openai.com/v1/responses',
                        {
                            ...
                            body: JSON.stringify({
                                ...
                                instructions: [
                                    ...
                                    'The description should only orient the learnerz to the conversation inside the set. Do not repeat the overall Discussion framing or explain the pedagogy.',
                                    '',
                                    ...
                                    'For grammar, vocabulary, pronunciation, communication, or other language-focused subjects, the question may begin with one concise teaching sentence, example, or contrast before the learner-facing question when that helps the learner notice a difference in form, meaning, tone, register, politeness, implication, or use.',
