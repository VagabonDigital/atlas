...
(function () {
    ...
    const STYLE_HREF =
        '/shared/atlas-account-chrome.css?v=20260924-enterlabel1';
    const GATE_STYLE_HREF =
        '/shared/atlas-account-gate.css?v=20260923-prohierarchy1';
    const GATE_SRC =
        '/shared/atlas-account-gate.js?v=20260925-checkoutfinal1';
    const PRO_CHECKOUT_SRC =
        '/shared/atlas-pro-checkout.js?v=20260925-checkoutfinal1';
    ...
    function createInsideAtlasEntry(container) {
        ...
        if (!container.querySelector('[data-atlas-inside-account]')) {
            container.innerHTML = `
            <a class="atlas-inside-account-action atlas-inside-account-explore" href="/?entry=product" data-atlas-product-entry><span class="atlas-inside-account-explore-label">Explore Atlas</span><span class="atlas-inside-account-enter-label">Enter Atlas</span></a>
